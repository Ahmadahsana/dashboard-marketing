    ...
    <div class="flex-none w-full max-w-full px-3">
        ...
        >
            ...
            <div
                class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent"
            >
                <h6 class="dark:text-white">List Katalog</h6>
            </div>
            <div class="flex-auto px-0 pt-0 pb-2">
                <div class="p-0 overflow-x-auto">
                    ...
                    >
                        ...
                        <tbody>
                            @foreach ($listKatalog as $katalog)
                            ...
                            <tr>
                                ...
                                >
                                        <span
                                        class=" @if($katalog->status == 'kontrak') bg-blue-600 text-white @elseif($katalog->status == 'deal') bg-teal-600 text-white @elseif($katalog->status == 'nego') bg-orange-300 text-orange-900 @endif px-2.5 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none "
                                        >{{ $katalog->status }}</span
                                    >
                                </td>
                                <td
